...
export interface ISelect
  extends BaseField<"select" | "multi-select", string | string[]> {
...
export interface ISlider
  extends Omit<BaseField<"slider", number>, "description" | "placeholder"> {
  min?: number;
  max?: number;
  step?: number;
}
...
export interface ITimeInput
  extends Omit<BaseField<"time", string>, "placeholder"> {
  format?: "12" | "24";
  clearable?: boolean;
}
